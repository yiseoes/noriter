...
class ProjectTest {
    ...
    void create_setsDefaultValues() {
        Project project = Project.create("테스트 게임", "테스트 요구사항입니다", Genre.ACTION, 3, false);
    ...
    void updateStatus_toCompleted_setsCompletedAt() {
        Project project = Project.create("게임", "요구사항 10자 이상", Genre.PUZZLE, 3, false);
    ...
    void updateProgress_updatesValues() {
        Project project = Project.create("게임", "요구사항 10자 이상", Genre.ACTION, 3, false);
