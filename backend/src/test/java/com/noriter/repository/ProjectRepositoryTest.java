...
class ProjectRepositoryTest {
    ...
    void save_and_findById() {
        Project project = Project.create("테스트 게임", "뱀파이어 서바이벌 류 미니게임을 만들어줘", Genre.ACTION, 3, false, null, null);
    ...
    void findByStatus_filtersCorrectly() {
        Project p1 = Project.create("게임1", "요구사항 10자 이상입니다 1", Genre.ACTION, 3, false, null, null);
        Project p2 = Project.create("게임2", "요구사항 10자 이상입니다 2", Genre.PUZZLE, 3, false, null, null);
    ...
    void delete_removesProject() {
        Project project = Project.create("삭제 테스트", "요구사항 10자 이상입니다", Genre.ARCADE, 3, false, null, null);
        projectRepository.save(project);
